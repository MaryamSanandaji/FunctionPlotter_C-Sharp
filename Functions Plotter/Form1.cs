...
namespace Functions_Plotter
{
    public partial class Form1 : Form
    {
        ...
        private void button_ToCentre_Click_1(object sender, EventArgs e)
        {
            float aux = Xmax - Xmin;
            Xmax = aux / 2;
            Xmin = -aux / 2;
        ...
        private void button_Reset_Click_2(object sender, EventArgs e)
        {
            Xmin = -10;
            Xmax = 10;
            Ymin = -10;
        ...
        private void button_Apply_Click_2(object sender, EventArgs e)
        {
            try
            {
        ...
        private void radioButton_NoAxis_CheckedChanged(object sender, EventArgs e)
        {
            pictureBox_Surface.Refresh();
        }

        private void radioButton_SimpleAxis_CheckedChanged(object sender, EventArgs e)
        {
            pictureBox_Surface.Refresh();
        }

        private void radioButton_AxisMarks_CheckedChanged(object sender, EventArgs e)
        {
            pictureBox_Surface.Refresh();
        }

        private void radioButton_AxisMArksValues_CheckedChanged(object sender, EventArgs e)
        {
            pictureBox_Surface.Refresh();
        }

        private void radioButton_BothAxis_CheckedChanged(object sender, EventArgs e)
        {
            pictureBox_Surface.Refresh();
        }

        private void radioButton_Horizontal_CheckedChanged(object sender, EventArgs e)
        {
            pictureBox_Surface.Refresh();
        }

        private void radioButton_Vertical_CheckedChanged(object sender, EventArgs e)
        {
            pictureBox_Surface.Refresh();
        }

        private void pictureBox_BackgroundColor_Click_1(object sender, EventArgs e)
        {
        ...
        private void pictureBox_AxisColor_Click_1(object sender, EventArgs e)
        {
            if (colorDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
